/**
 * Description: CIceTermPipe class implements pipe server related functionality.
...
public:
     ...
     */
    CIceTermPipe(std::wstring& sName, CConEmuMain *gpConEmu);

    /**
     * Destructor
     */
    virtual ~CIceTermPipe(void);
